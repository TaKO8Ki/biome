...
//!
//! This is inspired by [serde](https://serde.rs/).
...
///
/// ```
/// use biome_deserialize::{DeserializationDiagnostic,  Deserializable, DeserializableValue};
...
///             let Some(key) = String::deserialize(key, diagnostics) else {
///                 continue;
///             };
///             match key {
///                 "name" => {
