            ...
            fn visit_map(
                ...
                for (key, value) in members {
                    ...
                    match key.text() {
                        ...
                        "noArguments" => {
                            result.no_arguments = RuleConfiguration::deserialize_from_rule_name(
                                "noArguments",
                                value,
                                diagnostics,
                            );
                        ...
                        "noNamespace" => {
                            result.no_namespace = RuleConfiguration::deserialize_from_rule_name(
                                "noNamespace",
                                value,
                                diagnostics,
                            );
                        ...
                        "noNegationElse" => {
                            result.no_negation_else = RuleConfiguration::deserialize_from_rule_name(
                                "noNegationElse",
                                value,
                                diagnostics,
                            );
                        ...
                        "noParameterProperties" => {
                            result.no_parameter_properties =
                                RuleConfiguration::deserialize_from_rule_name(
                                    "noParameterProperties",
                                    value,
                                    diagnostics,
                        ...
                        "noUnusedTemplateLiteral" => {
                            result.no_unused_template_literal =
                                RuleConfiguration::deserialize_from_rule_name(
                                    "noUnusedTemplateLiteral",
                                    value,
                                    diagnostics,
                        ...
                        "noVar" => {
                            result.no_var = RuleConfiguration::deserialize_from_rule_name(
                                "noVar",
                                value,
                                diagnostics,
                            );
                        ...
                        "useConst" => {
                            result.use_const = RuleConfiguration::deserialize_from_rule_name(
                                "useConst",
                                value,
                                diagnostics,
                            );
                        ...
                        "useDefaultParameterLast" => {
                            result.use_default_parameter_last =
                                RuleConfiguration::deserialize_from_rule_name(
                                    "useDefaultParameterLast",
                                    value,
                                    diagnostics,
                        ...
                        "useExponentiationOperator" => {
                            result.use_exponentiation_operator =
                                RuleConfiguration::deserialize_from_rule_name(
                                    "useExponentiationOperator",
                                    value,
                                    diagnostics,
                        ...
                        "useLiteralEnumMembers" => {
                            result.use_literal_enum_members =
                                RuleConfiguration::deserialize_from_rule_name(
                                    "useLiteralEnumMembers",
                                    value,
                                    diagnostics,
                        ...
                        "useSelfClosingElements" => {
                            result.use_self_closing_elements =
                                RuleConfiguration::deserialize_from_rule_name(
                                    "useSelfClosingElements",
                                    value,
                                    diagnostics,
                        ...
                        "useShorthandArrayType" => {
                            result.use_shorthand_array_type =
                                RuleConfiguration::deserialize_from_rule_name(
                                    "useShorthandArrayType",
                                    value,
                                    diagnostics,
                        ...
                        "useSingleCaseStatement" => {
                            result.use_single_case_statement =
                                RuleConfiguration::deserialize_from_rule_name(
                                    "useSingleCaseStatement",
                                    value,
                                    diagnostics,
                        ...
                        "useSingleVarDeclarator" => {
                            result.use_single_var_declarator =
                                RuleConfiguration::deserialize_from_rule_name(
                                    "useSingleVarDeclarator",
                                    value,
                                    diagnostics,
                        ...
                        "useTemplate" => {
                            result.use_template = RuleConfiguration::deserialize_from_rule_name(
                                "useTemplate",
                                value,
                                diagnostics,
                            );
                        ...
                        "useWhile" => {
                            result.use_while = RuleConfiguration::deserialize_from_rule_name(
                                "useWhile",
                                value,
                                diagnostics,
                            );
